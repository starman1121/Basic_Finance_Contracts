...
contract BASICSHARE is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 BASICSHAREs
    ...
    constructor(uint256 _startTime, address _devFund) public ERC20("BASICSHARE", "BASICSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 COMET Share for initial pools deployment
